...
public:
    Tracking(System* pSys, ORBVocabulary* pVoc, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Map* pMap,
             KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor, shared_ptr<PointCloudMappingClient> pPointCloud);
...
protected:
    ...
    cv::Mat mImRGB;
    cv::Mat mImDepth;
    shared_ptr<PointCloudMappingClient>  mpPointCloudMappingClient;
};
